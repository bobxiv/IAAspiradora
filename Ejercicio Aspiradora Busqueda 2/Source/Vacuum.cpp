...
Vacuum::Vacuum()
{
	...
	{
		case 1:
			m_Posicion.x = ROOM1_X;
			m_Posicion.y = ROOM1_Y;
			break;
		case 2:
			m_Posicion.x = ROOM2_X;
			m_Posicion.y = ROOM2_Y;
			break;
		case 3:
			m_Posicion.x = ROOM3_X;
			m_Posicion.y = ROOM3_Y;
			break;
		case 4:
			m_Posicion.x = ROOM4_X;
			m_Posicion.y = ROOM4_Y;
			break;
	}
...
void Vacuum::Update(float dt)
{
	...
	if( m_CurrentState == "H1" || m_CurrentState == "H2" || m_CurrentState == "H3" || m_CurrentState == "H4" )
	{
...
void Vacuum::MoveH1()
{
	...
	m_Aux = sf::Vector2f( ROOM1_X, ROOM1_Y);
}
...
void Vacuum::MoveH2()
{
	...
	m_Aux = sf::Vector2f( ROOM2_X, ROOM2_Y);
}
...
void Vacuum::MoveH3()
{
	...
	m_Aux = sf::Vector2f( ROOM3_X, ROOM3_Y);
}
...
void Vacuum::MoveH4()
{
	...
	m_Aux = sf::Vector2f( ROOM4_X, ROOM4_Y);
}
