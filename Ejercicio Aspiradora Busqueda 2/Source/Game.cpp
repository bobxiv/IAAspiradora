...
Game::Game(): m_Window(sf::VideoMode(600,600,32), "Agente Aspiradora Busqueda"), m_Pausa(true), m_PausaLabel("Pausa")
{
	m_Window.Show(true);
	m_Window.SetFramerateLimit(60);

	m_PausaLabel.SetPosition( 300 - m_PausaLabel.GetRect().GetWidth()/2.0f,300 + m_PausaLabel.GetRect().GetHeight()/2.0f);
